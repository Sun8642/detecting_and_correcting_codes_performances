...
public class CrcPerformance {
    ...
    public static void main(String[] args) {
        String encode = CyclicRedundancyCode.encode(toBinary("coucou"), "100110000010001110110110111");
        System.out.println(encode);

//        testPerformanceCRC();
//        testPerformanceCRC_bigMessage();
//        testPerformancePolynomialArithmeticModulo2();
    }
    ...
    public static void testPerformanceCRC() {
    ...
    public static void testPerformanceCRC_bigMessage() {
    ...
    public static void testPerformancePolynomialArithmeticModulo2() {
        String message = "10010101010101010101010";
        String generatorPolynomial = "1000110110010101";
